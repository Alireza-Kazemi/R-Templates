ggplot(data = datPerformance, aes(x = timePoint, y = Age, fill = timePoint))+
  geom_boxplot()+
  geom_jitter(position = position_jitterdodge(jitter.width = 1),shape = 21)+
  geom_point(stat = "summary",fun = "mean", aes(shape = "MeanShape"), size = 2,color = "red")+
  guides(fill = "none")+
